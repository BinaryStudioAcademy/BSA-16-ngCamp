...
class httpGeneral {
    ...
    sendRequest(object) {
        ...
        if (typeof object.url !== 'string' || object.url === undefined || object.url.length === 0) {
            ...
            if (object.url.indexOf('user.json') === -1 && object.url.indexOf('users.json') === -1 && object.url.indexOf('/profile/user/getByCentralId/') === -1 && object.url.indexOf('team.binary-studio.com') === -1) {

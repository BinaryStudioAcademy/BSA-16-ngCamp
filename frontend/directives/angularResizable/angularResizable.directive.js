import './angular-resizable.min.css';
function angularResizableDirective() {
        let toCall;
        ...
        return {
            ...
            link: function(scope, element, attr) {
                let flexBasis = 'flexBasis' in document.documentElement.style ? 'flexBasis' :
                ...
                let dragging = function(e) {
                    let prop, offset = axis === 'x' ? start - getClientX(e) : start - getClientY(e);
                    switch(dragDir) {
                        case 'top':
                ...
                let dragStart = function(e, direction) {
                    dragDir = direction;
                ...
                dir.forEach(function (direction) {
                    ...
                    let down = function(e) {
                        let disabled = (scope.rDisabled === 'true');
